...
: ${AMENT_CURRENT_PREFIX:="/home/pheonix/ros2_ws/install/rosbag2_test_common"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rosbag2_test_common/environment/pythonpath.sh"
