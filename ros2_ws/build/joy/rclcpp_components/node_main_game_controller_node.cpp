...
#define NODE_MAIN_LOGGER_NAME "game_controller_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgame_controller.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<joy::GameController>";
