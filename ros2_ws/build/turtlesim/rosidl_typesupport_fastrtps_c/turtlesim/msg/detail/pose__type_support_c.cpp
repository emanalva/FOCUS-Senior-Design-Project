  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlesim__msg__Pose;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const turtlesim__msg__Pose * ros_message = static_cast<const turtlesim__msg__Pose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_turtlesim__msg__Pose(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim__msg__Pose * ros_message = static_cast<turtlesim__msg__Pose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_turtlesim__msg__Pose(cdr, ros_message);
}
