...
static const _Spawn_Event_type_support_symbol_names_t _Spawn_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim, srv, Spawn_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim, srv, Spawn_Event)),
  }
};
...
{
  return &::turtlesim::srv::rosidl_typesupport_cpp::Spawn_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim, srv, Spawn_Event)() {
  return get_message_type_support_handle<turtlesim::srv::Spawn_Event>();
}
...
static const rosidl_service_type_support_t Spawn_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<turtlesim::srv::Spawn_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<turtlesim::srv::Spawn_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<turtlesim::srv::Spawn_Event>(),
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim, srv, Spawn)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<turtlesim::srv::Spawn>();
}
